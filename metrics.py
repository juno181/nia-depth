...
class Result(object):
    ...
    def evaluate(self, output, target):
        ...
        self.lg10 = float((torch.log10(output_mm) - torch.log10(target_mm)).abs().mean())
        ...
        self.silog = torch.sqrt(normalized_squared_log -
        ...
        self.irmse = torch.sqrt((torch.pow(abs_inv_diff, 2)).mean())
