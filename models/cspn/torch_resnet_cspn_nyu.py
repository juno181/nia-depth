...
model_path ={
    'resnet18': 'models/cspn/resnet18.pth',
    'resnet50': 'models/cspn/resnet50.pth'
}
...
class ResNet(nn.Module):
    def __init__(self, block, layers, up_proj_block, cspn_config=None):
        ...
        self.gud_up_proj_layer1 = self._make_gud_up_conv_layer(Gudi_UpProj_Block, 512, 256, 22, 76)
        self.gud_up_proj_layer2 = self._make_gud_up_conv_layer(Gudi_UpProj_Block_Cat, 256, 128, 44, 152)
        self.gud_up_proj_layer3 = self._make_gud_up_conv_layer(Gudi_UpProj_Block_Cat, 128, 64, 88, 304)
        self.gud_up_proj_layer4 = self._make_gud_up_conv_layer(Gudi_UpProj_Block_Cat, 64, 64, 176, 608)
        self.gud_up_proj_layer5 = self._make_gud_up_conv_layer(Simple_Gudi_UpConv_Block_Last_Layer, 64, 1, 352, 1216)
        self.gud_up_proj_layer6 = self._make_gud_up_conv_layer(Simple_Gudi_UpConv_Block_Last_Layer, 64, 8, 352, 1216)
